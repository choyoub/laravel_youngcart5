...
class CreateG5MemberTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('g5_member', function(Blueprint $table){
          ...
          $table->tinyInteger('mb_mailling', 4);
          $table->tinyInteger('mb_sms', 4);
          $table->tinyInteger('mb_open', 4);
